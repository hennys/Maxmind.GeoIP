...
namespace Pixie.Extensions.Maxmind.GeoIp.Models
{
    ...
    {
        private static readonly IDictionary<string, IDictionary<string, string>> _regions = Geographics.InitRegionNames();

        private static readonly IList<Country> _countries = new List<Country>
        {
            new Country("--", "N/A"),
            new Country("AP", "Asia/Pacific Region"),
            ...
            new Country("A1", "Anonymous Proxy"),
            new Country("A2", "Satellite Provider"),
            new Country("O1", "Other"),
        ...
        private static Dictionary<string, string> _continents = new Dictionary<string, string>
        {
            {
                "AF",
                "Africa"
        ...
        private static Dictionary<string, string> _countryToContinent = new Dictionary<string, string>
        {
            {
                "A1",
                "--"
        ...
        public static IDictionary<string, IDictionary<string, string>> Regions
        {
            get
            {
                return Geographics._regions;
            }
        }
        ...
        public static IList<Country> Countries
        {
            get
            {
                return Geographics._countries;
            }
        }

        public static Dictionary<string, string> Continents
        {
            get
            {
                return Geographics._continents;
            }
        }

        public static IDictionary<string, string> CountryToContinent
        {
            get
            {
                return Geographics._countryToContinent;
            }
        }

        public static string GetRegionName(string countryCode, string region)
        {
            if (region == null || region == "00")
            {
                return null;
            }
            if (!Geographics._regions.ContainsKey(countryCode))
            {
                return null;
            }
            return Geographics._regions[countryCode][region];
        }
